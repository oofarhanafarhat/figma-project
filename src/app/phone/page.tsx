...
const Ph = () => {
  return (
    <div className=' w-auto h-auto  sm:w-[1170px] sm:h-[603px] justify-center ml-10 opacity-100'>
        ...
        <input type="text" placeholder='Interested IN ' className='bg-gray-300 text-opacity-100  py-5 rounded-lg pl-4 bg-opacity-100' />
            ...
            <div>
               < Image src="/image06.png" width={749}height={369}alt='' className=' w-auto h-auto sm:w-[]749 sm:h-[369]'/> 
            </div>
        </div>
